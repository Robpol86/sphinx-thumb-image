...
- New directive `list-table-thumbs` ([#72](https://github.com/Robpol86/sphinx-thumb-image/issues/72))
- `:resize-quality:` directive option ([#28](https://github.com/Robpol86/sphinx-thumb-image/issues/28))
